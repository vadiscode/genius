...
public class Menu extends UI {
    ...
    public void categoryPanelConstructor(CategoryPanel categoryPanel, CategoryButton categoryButton, float x, float y) {
        ...
        if(categoryButton.name == "Render") {
            ...
            int row = 0;
            for(Module module : Client.getModuleManager().getArray()) {
                if(module.getType() == ModuleData.Type.Render) {
                    categoryPanel.buttons.add(new Button( categoryPanel, module.getName(), xOff, yOff, module));
                    y = 8;
                    if (getSettings(module) != null) {
                        for (Setting setting : getSettings(module)) {
        ...
        if(categoryButton.name == "Misc") {
            float biggestY = yOff + 8;
            for(Module module : Client.getModuleManager().getArray()) {
                if(module.getType() == ModuleData.Type.Misc) {
                    categoryPanel.buttons.add(new Button( categoryPanel, module.getName(), xOff, yOff, module));
                    y = 8;
                    if (getSettings(module) != null) {
                        for (Setting setting : getSettings(module)) {
    ...
    @Override
    public void groupBoxConstructor(GroupBox var1, float var2, float var3) {

    }

    @Override
    public void groupBoxMouseClicked(GroupBox var1, int var2, int var3, int var4) {

    }

    @Override
    public void groupBoxDraw(GroupBox var1, float var2, float var3) {

    }

    @Override
    public void groupBoxMouseMovedOrUp(GroupBox var1, int var2, int var3, int var4) {
