package genius.util.render.font;
...
public class TTFFontRenderer extends CFont
{
    ...
    public void drawBorderedString(String text, float x, float y, int color) {
        ...
        this.drawString(text, x, y, Colors.getColor(0), false);
    ...
    public void drawCenteredString(String text, float x, float y, int color) {
        float width = this.getStringWidth(text) / 2.0f;
        float height = this.getStringHeight(text) / 2.0f;
        this.drawString(text, x - width, y - height, color, false);
    }
